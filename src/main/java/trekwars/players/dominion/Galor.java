package trekwars.players.dominion;
...
public class Galor extends AbstractPlayer {
    ...
    public Galor(
        ...
        super(
                ...
                camera,
                explosionNode,
                PlayerFactoryType.CardassianGalor
                );
        cube = assetManager.loadModel("Models/cardassian-galor.obj");
