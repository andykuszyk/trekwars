...
public class TacticalCube extends AbstractPlayer {
    ...
    public TacticalCube(
        ...
        super(
                ...
                camera,
                explosionNode,
                PlayerFactoryType.BorgTacticalCube
                );
        cube = assetManager.loadModel("Models/tactical-cube.obj");
