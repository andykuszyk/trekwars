package trekwars.players.imperial;
...
public class StarDestroyer extends AbstractPlayer {

    private final Spatial starDestroyer;
    ...
    public StarDestroyer(
        ...
        spatialNode.attachChild(starDestroyer);
